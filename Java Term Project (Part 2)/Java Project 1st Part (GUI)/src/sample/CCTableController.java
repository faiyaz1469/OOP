...
public class CCTableController {
    ...
    public CCTableController() throws Exception {
    }
    ...
    public void load(String cName, String clName) throws Exception {
        if (init) {
            initializeColumns();
            init = false;
        }

        List<Player> plrList = pList.getSameCountryClubList(cName,clName);
        ...
        @FXML
        public void backPLayersMenu(ActionEvent event) throws Exception {
