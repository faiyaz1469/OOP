...
public class ClMaxHeightPlTableController {
    ...
    public ClMaxHeightPlTableController() throws Exception {
    }


    private void initializeColumns() {
        TableColumn<Person, String> playerNameCol = new TableColumn<>("Name");
        playerNameCol.setMinWidth(120);
    ...
    public void load(String clubName) throws Exception {
        if (init) {
            initializeColumns();
            init = false;
        }

        List<Player> plrList = pList.getMaxHeightClubList(clubName);
